...
public class ColorBlobDetectionActivity extends Activity implements
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		//mBlobColorHsv = new Scalar(252, 198, 181, 0.0);
		System.out.println("Touch hsv" +mBlobColorHsv);
		...
		//oberster punkte x = 1, unterster x = 238 -> mitte 119
		//links y = 178; rechts y = 1 -> 9
		
		System.out.println("Touch "+mDetector.getCoordinates().x + ", " + mDetector.getCoordinates().y);
